...
## 👥 Demo data
Demo seeding has been removed from this project to prevent accidental population of test accounts. If you need demo data in the future, add it via your own scripts in `kalasetu-backend/scripts/` and wire custom commands in `package.json` locally.
