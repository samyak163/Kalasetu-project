...
| Dispute Resolution | Chat history + booking records + admin intervention | Manual initially |
...
| fullName | String | Customer's full name | Required, 2-50 chars |
...
| firebaseUID | String | Firebase user ID (OAuth) | Optional, unique |
...
| balance | Number | NEW | Available earnings (₹) |
...
| duration | Number | Estimated duration (minutes) | Optional |
...
| artisanEarning | Number | NEW Amount payable to artisan | amount - commission |
| invoiceUrl | String | NEW PDF invoice URL | Cloudinary URL |
...
| updatedAt | Date | Last update | Auto-generated (for edits) |
...
| recordingUrl | String | Recording URL (if any) | Optional |
