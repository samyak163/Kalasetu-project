        ...
        <div className="container mx-auto max-w-7xl">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
                {mockCategories.map(category => (
                    <Link to={`/search?category=${encodeURIComponent(category.name)}`} key={category.name} className="relative rounded-lg overflow-hidden group cursor-pointer shadow-lg">
