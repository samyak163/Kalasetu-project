...
Use XML tags when a prompt has **3+ distinct sections** (context, task, constraints, output format). XML tags help Claude parse structured prompts — Anthropic's own research confirms this.
